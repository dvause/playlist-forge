...
- `CLAUDE.md` should only point back to `AGENTS.md` to avoid duplicated guidance.
- Some tooling may still look for docs under `.Codex/docs/`; in this repo the maintained location is `.claude/docs/`.
